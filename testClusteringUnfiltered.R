#This is a test clustering file for all SRA runs from NCBI 
#Unfiltered Cell Ranger output 
...
#run in terminal
Combined_path<-paste(current_path, "/test_combined_cellranger_output/outs/raw_feature_bc_matrix", sep="")    #path to Combined data 
SAN_path<-paste(current_path, "/test_SAN_cellranger_output/outs/raw_feature_bc_matrix", sep="")              #path to SAN data 
AVN_path<-paste(current_path, "/test_AVN_cellranger_output/outs/raw_feature_bc_matrix", sep="")              #path to AVN data 
LPF_path<-paste(current_path, "/test_LPF_cellranger_output/outs/raw_feature_bc_matrix", sep="")              #path to LPF data 
RPF_path<-paste(current_path, "/test_RPF_cellranger_output/outs/raw_feature_bc_matrix", sep="")              #path to RPF data 
...
zoneALL_tsne_path<-paste(current_path, "/seurat_output/unfiltered_test_zoneALL_tsne.jpeg", sep="")    #path to zone ALL tsne
zoneI_tsne_path<-paste(current_path, "/seurat_output/unfiltered_test_zoneI_tsne.jpeg", sep="")    #path to zone I tsne
zoneII_tsne_path<-paste(current_path, "/seurat_output/unfiltered_test_zoneII_tsne.jpeg", sep="")    #path to zone II tsne
zoneIII_tsne_path<-paste(current_path, "/seurat_output/unfiltered_test_zoneIII_tsne.jpeg", sep="")    #path to zone III tsne
